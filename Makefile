OBJETCS= ./build/compiler.o ./build/cprocess.o ./build/lex_process.o ./build/lexer.o ./build/helpers/buffer.o ./build/helpers/vector.o
INCLUDES= -I./

all: ${OBJETCS}
	gcc main.c ${INCLUDES} ${OBJETCS} -g -o ./main
